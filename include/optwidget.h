...
class OptWidget : public QVideoWidget
{
    Q_OBJECT
...
public:
    ...
    void setCross(CameraMode pCameraMode);
...
//    int  getDistanceToRect(QRect _rect, QPoint _point);
//    int  getDistanceToLine(QLine line, QPoint point);
    QRect norm(QRect rect);
    void updateRect();

private slots:
    void inversia(bool pButton);
