...
//config-----------------------------------------------------------------------
#include "cfgmanager.h"                         // Cfg

//support----------------------------------------------------------------------
#include "supportmanager.h"                     // Support
#include "weapon.enum.h"

#define MAX_SPEED_MOTORS    30
...
#define X_BORDER_MIN       -180.f
#define X_BORDER_MAX        180.f
#define Y_BORDER_MIN       -20.f
#define Y_BORDER_MAX        60.f
