...
void PID::pid_on_off(bool enabled, float Fact_Zn)
{
    ...
    if (1)
    {
        if (!enabled)		//ПИД\ШИМ выкл.
        {
            ...
            //emit readVarPid(pid.PidV, pid.P, pid.I, pid.D/*, pid.R1, pid.R2, pid.R3*/);
...
//    ui->r1X->setText(QString::number(r1));
//    ui->r2X->setText(QString::number(r2));
//    ui->r3X->setText(QString::number(r3));
}
...
//    ui->r1Y->setText(QString::number(r1));
//    ui->r2Y->setText(QString::number(r2));
//    ui->r3Y->setText(QString::number(r3));
}
...
/*
void PID::seePidX(float b1, float b2, float b3, float b4, float b5, float b6, float b7, float b8, float b9)
{
    ui->zonaX_read->setText(QString::number(b1));
    ui->tmlsX_read->setText(QString::number(b2));
    ui->pvesX_read->setText(QString::number(b3));
    ui->dvesX_read->setText(QString::number(b4));
    ui->maxuX_read->setText(QString::number(b5));
    ui->minuX_read->setText(QString::number(b6));
    ui->pkffX_read->setText(QString::number(b7));
    ui->tkffX_read->setText(QString::number(b8));
    ui->dkffX_read->setText(QString::number(b9));
}

void PID::seePidY(float b1, float b2, float b3, float b4, float b5, float b6, float b7, float b8, float b9)
{
    ui->zonaY_read->setText(QString::number(b1));
    ui->tmlsY_read->setText(QString::number(b2));
    ui->pvesY_read->setText(QString::number(b3));
    ui->dvesY_read->setText(QString::number(b4));
    ui->maxuY_read->setText(QString::number(b5));
    ui->minuY_read->setText(QString::number(b6));
    ui->pkffY_read->setText(QString::number(b7));
    ui->tkffY_read->setText(QString::number(b8));
    ui->dkffY_read->setText(QString::number(b9));
}*/
