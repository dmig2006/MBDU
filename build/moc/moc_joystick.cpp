...
QT_MOC_LITERAL(1, 9, 9), // "newLogMsg"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6) // "string"

    },
    "Joystick\0newLogMsg\0\0string"
};
...
void Joystick::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Joystick::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Joystick::newLogMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Joystick::newLogMsg(QString _t1)
{
